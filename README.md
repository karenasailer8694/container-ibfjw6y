...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-ibfjw6y.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-ibfjw6y.containers.anotherwebservice.com/
...
```
git clone git@github.com:karenasailer8694/container-ibfjw6y.git
cd container-ibfjw6y
```
...
```
docker attach container-ibfjw6y
```
